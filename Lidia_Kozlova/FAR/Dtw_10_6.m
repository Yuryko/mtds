...
%dtw Евклид    
Ppdtw(E)=Ppdtw(E-1) + 0.1*PL2; 
Pwdtw(E)=Pwdtw(E-1) + 0.1*PL2; 
%dtw квадратичный Евклид
Ppdtws(E)=Ppdtws(E-1)+0.3*PL2; 
Pwdtws(E)=Pwdtws(E-1)+0.3*PL2; 
...
Ppevsq(E)=Ppevsq(E-1)+PL2; 
Pwevsq(E)=Pwevsq(E-1)+PL2;
