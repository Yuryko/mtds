...
%dtw Евклид    
Ppdtw(E)=Ppdtw(E-1) + 0.2*PL2; 
Pwdtw(E)=Pwdtw(E-1) + 0.2*PL2; 
%dtw квадратичный Евклид
Ppdtws(E)=Ppdtws(E-1)+1*PL2; 
Pwdtws(E)=Pwdtws(E-1)+1*PL2; 

%dtw расстояние городских кварталов
Ppdtwea(E)=Ppdtwea(E-1)+0.3*PL2;
Pwdtwea(E)=Pwdtwea(E-1)+0.3*PL2;

% ситываем пороги для pdist2
%расстояние евклида
Ppev(E)=Ppev(E-1)+0.02*PL2;
Pwev(E)=Pwev(E-1)+0.02*PL2;

%квадратичное расстояние евклида
Ppevsq(E)=Ppevsq(E-1)+2*PL2; 
Pwevsq(E)=Pwevsq(E-1)+2*PL2;
...
Ppcit(E)=Ppcit(E-1)+0.5*PL2; 
Pwcit(E)=Pwcit(E-1)+0.5*PL2;
...
xlabel('линейное смещение порога')
ylabel('ошибка %') 
