...
Ppdtwea(E)=Ppdtwea(E-1)+0.05*PL2;
Pwdtwea(E)=Pwdtwea(E-1)+0.05*PL2;

% ситываем пороги для pdist2
%расстояние евклида
Ppev(E)=Ppev(E-1)+0.007*PL2;
Pwev(E)=Pwev(E-1)+0.007*PL2;
...
Pwevsq(E)=Pwevsq(E-1)+0.3*PL2;
 ...
 %расстояние чебышева
Ppch(E)=Ppch(E-1)+0.0007*PL2;
Pwch(E)=Pwch(E-1)+0.0007*PL2;

%расстояние городских кварталов
Ppcit(E)=Ppcit(E-1)+0.07*PL2; 
Pwcit(E)=Pwcit(E-1)+0.07*PL2;

%корреляционное расстояние
Ppcor(E)=Ppcor(E-1)+0.00007*PL2; 
Pwcor(E)=Pwcor(E-1)+0.00007*PL2; 
 
% косинусное расстояние
Ppcos(E)=Ppcos(E-1)+0.00007*PL2;
Pwcos(E)=Pwcos(E-1)+0.00007*PL2;

%расстояние минковского 
Ppmin(E)=Ppmin(E-1)+0.003*PL2; % не уменьшать
Pwmin(E)=Pwmin(E-1)+0.003*PL2; % не уменьшать
...
%  находим серидину для линии на графике
 ...
 % линяя на графике (44 координаты)
  ...
  % надписи на графиках
str1=sprintf('ph EER = %g', RDTWev1(ZDTWev1));
str2=sprintf('wh EER= %g', RDTWev2(ZDTWev2));
str3=sprintf('ph EER= %g', RDTWevsq1(ZDTWevsq1));
str4=sprintf('wh EER= %g', RDTWevsq2(ZDTWevsq2));
str5=sprintf('ph EER= %g', RDTWcit1(ZDTWcit1));
str6=sprintf('wh EER= %g', RDTWcit2(ZDTWcit2));
str7=sprintf('ph EER= %g', RPdev1(ZPdev1));
str8=sprintf('wh EER= %g', RPdev2(ZPdev2));
str9=sprintf('ph EER= %g', RPdevsq1(ZPdevsq1));
str10=sprintf('wh EER= %g', RPdevsq2(ZPdevsq2));
str11=sprintf('ph EER= %g', RPdcit1(ZPdcit1));
str12=sprintf('wh EER= %g', RPdcit2(ZPdcit2));
str13=sprintf('ph EER= %g', RPdmin1(ZPdmin1));
str14=sprintf('wh EER= %g', RPdmin2(ZPdmin2));
str15=sprintf('ph EER= %g', RPdche1(ZPdche1));
str16=sprintf('wh EER= %g', RPdche2(ZPdche2));
str17=sprintf('ph EER= %g', RPdcos1(ZPdcos1));
str18=sprintf('wh EER= %g', RPdcos2(ZPdcos2));
str19=sprintf('ph EER= %g', RPdcor1(ZPdcor1));
str20=sprintf('wh EER= %g', RPdcor2(ZPdcor2));
str21=sprintf('ph EER= %g', RPdspe1(ZPdspe1));
str22=sprintf('wh EER= %g', RPdspe2(ZPdspe2));
...
text(33000,RDTWev1(ZDTWev1)+3, str1) ;
b=plot(RCou2,'r');
plot(RDTWev2,'r');
plot(KDTWev2_1,KDTWev2_2);
text(33000,RDTWev2(ZDTWev2)+3, str2) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(9000,5, '\leftarrow ph FRR') ;
text(13000,80, '\leftarrow ph FAR') ;
text(13000,60, '\leftarrow wh FRR') ;
text(25000,50, '\leftarrow wh FAR') ;
...
text(25000,RDTWevsq1(ZDTWevsq1)+3, str3) ;
b=plot(RCous2,'r');
plot(RDTWevsq2,'r');
plot(KDTWevsq2_1,KDTWevsq2_2);
text(25000,RDTWevsq2(ZDTWevsq2)+3, str4) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(2000,90, '\leftarrow ph FRR') ;
text(12500,85, '\leftarrow ph FAR') ;
text(8000,60, '\leftarrow wh FRR') ;
text(22000,50, '\leftarrow wh FAR') ;
...
text(32000,RDTWcit1(ZDTWcit1)+3, str5) ;
b=plot(RCoua2,'r');
plot(RDTWcit2,'r');
plot(KDTWcit2_1,KDTWcit2_2);
text(32000,RDTWcit2(ZDTWcit2)+3, str6) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(500,15, 'ph FRR \rightarrow') ;
text(13000,15, '\leftarrow ph FAR') ;
text(19000,60, '\leftarrow wh FRR') ;
text(35000,50, '\leftarrow wh FAR') ;
...
o.LineWidth=1.7;
plot(Kev1_1,Kev1_2);
text(33000,RPdev1(ZPdev1)+3, str7) ;
b=plot(RCev2,'r');
plot(RPdev2,'r');
plot(Kev2_1,Kev2_2);
text(33000,RPdev2(ZPdev2)+3, str8) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(8000,95, '\leftarrow ph FRR') ;
text(12000,75, '\leftarrow ph FAR') ;
text(27000,20, '\leftarrow wh FRR') ;
text(27000,82, '\leftarrow wh FAR') ;
...
text(33000,RPdevsq1(ZPdevsq1)+3, str9) ;
b=plot(RCevsq2,'r');
plot(RPdevsq2,'r');
plot(Kevsq2_1,Kevsq2_2);
text(33000,RPdevsq2(ZPdevsq2)+3, str10) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(7500,95, '\leftarrow ph FRR') ;
text(12500,15, '\leftarrow ph FAR') ;
text(25500,70, '\leftarrow wh FRR') ;
text(17000,25, '\leftarrow wh FAR') ;
...
text(1000,RPdcit1(ZPdcit1)+3, str11) ;
b=plot(RCcit2,'r');
plot(RPdcit2,'r');
plot(Kcit2_1,Kcit2_2);
text(1000,RPdcit2(ZPdcit2)+3, str12) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(18000,3, 'ph FRR \rightarrow') ;
text(9000,15, 'ph FAR \rightarrow') ;
text(29000,65, 'wh FRR \rightarrow') ;
text(28000,50, 'wh FAR \rightarrow') ;
...
text(1000,RPdmin1(ZPdmin1)+3, str13) ;
b=plot(RCmin2,'r');
plot(RPdmin2,'r');
plot(Kmin2_1,Kmin2_2);
text(1000,RPdmin2(ZPdmin2)+3, str14) ;

legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});

text(22000,30, 'ph FRR \rightarrow') ;
text(22000,7, ' ph FAR \rightarrow') ;
text(29000,60, 'wh FRR \rightarrow') ;
text(44000,30, ' wh FAR \rightarrow') ;
...
text(100,RPdche1(ZPdche1)+3, str15) ;
b=plot(RCche2,'r');
plot(RPdche2,'r');
plot(Kche2_1,Kche2_2);
text(100,RPdche2(ZPdche2)+3, str16) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(5000,75, 'ph FRR \rightarrow') ;
text(2000,8, 'ph FAR \rightarrow') ;
text(28000,50, '\leftarrow wh FRR') ;
text(20000,25, '\leftarrow wh FAR') ;
...
text(1000,RPdcos1(ZPdcos1)+3, str17) ;
b=plot(RCcos2,'r');
plot(RPdcos2,'r');
plot(Kcos2_1,Kcos2_2);
text(1000,RPdcos2(ZPdcos2)+3, str18) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(11000,80, ' ph FRR \rightarrow') ;
text(17000,8, 'ph FAR \rightarrow') ;
text(25000,77, 'wh FRR \rightarrow') ;
text(39700,28, '\leftarrow wh FAR') ;
...
text(1000,RPdcor1(ZPdcor1)+3, str19) ;
b=plot(RCcor2,'r');
plot(RPdcor2,'r');
plot(Kcor2_1,Kcor2_2);
text(1000,RPdcor2(ZPdcor2)+3, str20) ;
legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(11000,80, ' ph FRR \rightarrow') ;
text(16000,8, 'ph FAR \rightarrow') ;
text(25000,77, 'wh FRR \rightarrow') ;
text(39700,28, '\leftarrow wh FAR') ;
...
text(32000,RPdspe1(ZPdspe1)+3, str21) ;
b=plot(RCspe2,'r');
plot(RPdspe2,'r');
plot(Kspe2_1,Kspe2_2);
text(32000,RPdspe2(ZPdspe2)+3, str22) ;

legend([p,b],{'smartphone (ph)', 'smartwatch (wh)'});
text(3000,45, 'ph FRR \rightarrow') ;
text(4500,8, 'ph FAR \rightarrow') ;
text(26000,8, '\leftarrow wh FRR') ;
text(25000,50, '\leftarrow wh FAR  ') ;
